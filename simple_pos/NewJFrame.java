  ...
  public void addtable(int id ,String Name, int Qty ,Double Price){
   ...
   double tot = 0.0 ;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        addtables(1, "Large Truffles  ", i, 750.0);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        addtables(2, "Dark Chocolate  ", i, 550.0);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        addtables(3, "Special Pinapple  ", i, 650.0);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        addtables(4, "FullCream Strawberry  ", i, 980.0);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        addtables(5, "BlackWhite Chocolate  ", i, 760.0);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        addtables(6, "Oreo Whiteforest", i, 890.0);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        addtables(7, "Pink Velvet", i, 630.0);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        addtables(8, "Double Layer  ", i, 450.0);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
       // btn code
        ...
        addtables(9, "Birthday Special  ", i, 990.0);
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        try {
           ...
           b.setText("                         LOVELY BAKE STUDIO \n");
            b.setText(b.getText() + "                         56 UNIMALL Road, \n");
            b.setText(b.getText() + "                         PHAGWARA, INDIA, \n");
            b.setText(b.getText() + "                         +918235556222, \n");
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            ...
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            b.setText(b.getText() + "                     Thanks, Visit again!!"+"\n");
            b.setText(b.getText() + "---------------------------------------------------------------------\n");
            b.setText(b.getText() + "                     PROJECT BY BUNNYSAYZZ"+"\n");
